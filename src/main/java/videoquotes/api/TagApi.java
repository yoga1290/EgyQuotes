...
import videoquotes.model.repository.TagRepository;
...
public class TagApi
{
    ...
    @ApiOperation(value = "Returns Tags for a given QuoteId", notes = "Returns Tags for a given QuoteId [offset|limit]")
    public @ResponseBody List<Tag> findByQuoteId(
	    @RequestParam String quoteId,
	    @RequestParam(required = false, defaultValue = "0") int offset,
	    @RequestParam(required = false, defaultValue = "50") int limit) {
	return tagRepository.findByQuoteId(quoteId, offset, limit);
    }
    ...
    @ApiOperation(value = "Search Tags", notes = "Search Tags [offset|limit]")
    public @ResponseBody List<Tag> findByTag(
	    @RequestParam String tag,
	    @RequestParam(required = false, defaultValue = "0") int offset,
	    @RequestParam(required = false, defaultValue = "50") int limit) {
	return tagRepository.findByTag(tag, offset, limit);
    }
}
